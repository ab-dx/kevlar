...
export function HeroSection() {
	...
	return (
		<motion.div
			...
			initial="hidden"
			animate="visible"
			className="flex min-h-[500px] flex-col items-center justify-center px-4 py-16 text-center z-100"
		>
			...
			>
				Kevlar is a bullet-proof platform for your digital asset needs.
				Organize, approve, version and distribute your team's assets, all in one
				place.
			</motion.p>
