            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="px-4 py-2 text-right font-medium">Assets Created</th>
                  <th className="px-4 py-2 text-right font-medium">Assets Approved</th>
                  <th className="px-4 py-2 text-right font-medium">Versions Uploaded</th>
                  <th className="px-4 py-2 text-right font-medium">Links Created</th>
                </tr>
              </thead>
              <tbody>
                {(employees || []).length === 0 ? (
                  ...
                  (employees || []).map((emp) => (
                    <tr key={emp.userId} className="border-b hover:bg-muted/30">
                      ...
                      <td className="px-4 py-2 text-right">{emp.assetsCreated}</td>
                      <td className="px-4 py-2 text-right">{emp.assetsApproved}</td>
                      <td className="px-4 py-2 text-right">{emp.versionsUploaded}</td>
                      <td className="px-4 py-2 text-right">{emp.linksCreated}</td>
                    </tr>
                  ))
                )}
              </tbody>
